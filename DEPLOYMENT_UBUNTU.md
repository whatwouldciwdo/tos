...
2. `tor-online-ws` — WebSocket Collaboration Server (Port `3121`)

---

## 🔒 5. Konfigurasi Firewall Ubuntu (UFW)

Buka port `3120` (Web App) dan `3121` (WebSocket Server) pada firewall Ubuntu agar dapat diakses dari jaringan lokal:

```bash
# Buka port 3120 dan 3121
sudo ufw allow 3120/tcp comment 'TOR Online Web App'
sudo ufw allow 3121/tcp comment 'TOR Online WebSocket Collaboration'
...
- **WebSocket Server**: `ws://10.8.140.67:3121`
- **Health Check WebSocket**: `http://10.8.140.67:3121`
